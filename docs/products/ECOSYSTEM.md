...
| Property | Path | Role |
| --- | --- | --- |
| omniacreata.com | `website/omniacreata-com` | Public HQ and product marketing |

## Incubation

| Area | Path | Role |
| --- | --- | --- |
| OmniaTools lab | `prototypes/omniatools-lab` | Micro-tool incubation before a future `OmniaTools` product |
