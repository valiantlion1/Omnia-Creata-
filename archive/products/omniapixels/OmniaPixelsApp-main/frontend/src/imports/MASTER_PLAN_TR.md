...
| G2 | Mobil iskelet (9 ekran, tema, routing) | 🟡 %75 |
| G3 | Backend↔Mobil bağlama | ❌ %10 |
| G4 | ZeroCost offline zincir | ❌ %5 |
| G5 | AI Router | ❌ %0 |
| G6 | Push + E-posta | ❌ %0 |
| G7 | Ödeme/Stripe sandbox | ❌ %0 |
| G8 | Admin/Flags | ❌ %5 |
| G9 | CI/CD + Yedek | ❌ %10 |
| G10 | Release Candidate + final_proof.zip | ❌ %0 |
