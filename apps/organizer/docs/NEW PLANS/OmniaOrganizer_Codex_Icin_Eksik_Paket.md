...
## A. `apps/omniaorganizer/AGENTS.md`
### Amaç
...
## B. `apps/omniaorganizer/PRODUCT_BLUEPRINT.md`
### Amaç
...
## C. `apps/omniaorganizer/PLAN_PHASE_0.md`
### Amaç
...
## D. `apps/omniaorganizer/PLAN_PHASE_1.md`
### Amaç
...
## E. `apps/omniaorganizer/PLAN_PHASE_2.md`
### Amaç
...
## F. `apps/omniaorganizer/MODULE_SPECS/`
### Amaç
...
## G. `apps/omniaorganizer/SCREEN_SPECS/`
### Amaç
...
## H. `apps/omniaorganizer/TECH_CONSTRAINTS.md`
### Amaç
...
## I. `apps/omniaorganizer/FEATURE_MATRIX.md`
### Amaç
...
## J. `apps/omniaorganizer/ACCEPTANCE_CRITERIA.md`
### Amaç
...
## K. `apps/omniaorganizer/RISK_REGISTER.md`
### Amaç
