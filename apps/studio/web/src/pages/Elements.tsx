  ...
  return (
    <div className="mx-auto flex w-full max-w-[1620px] flex-col gap-6 px-4 py-6 md:px-6">
      <section className="space-y-4">
        ...
        <h1 className="text-3xl font-semibold tracking-tight text-white">Styles</h1>
      </section>

      <section className="flex items-center gap-3">
        <button className="rounded-full bg-white px-4 py-2 text-sm font-medium text-black">Explore</button>
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <div className="flex min-h-[360px] flex-col justify-between rounded-[28px] border border-dashed border-white/12 bg-[#141519] p-5">
          <div className="flex h-16 w-16 items-center justify-center rounded-3xl bg-white/[0.04] text-zinc-400 ring-1 ring-white/8">
        ...
        {styleCards.map((card) => (
          <div key={card.id} className="overflow-hidden rounded-[28px] border border-white/8 bg-[#141519]">
