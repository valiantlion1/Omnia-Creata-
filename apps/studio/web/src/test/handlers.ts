...
export const samplePublicPlans: PublicPlansPayload = {
  ...
  subscriptions: [
    {
      ...
      feature_summary: ['4,000 monthly credits', 'Newer image models'],
      price_usd: 12,
    ...
    },
    {
      ...
      feature_summary: ['12,000 monthly credits', 'Advanced and newest image models'],
      price_usd: 24,
      billing_period: 'month',
  ...
  credit_packs: [
    { kind: 'credit_pack_small', label: 'Credit pack 2,000', credits: 2000, price_usd: 8, plan: null },
    { kind: 'credit_pack_large', label: 'Credit pack 8,000', credits: 8000, price_usd: 24, plan: null },
  ],
  wallet: {
...
export const sampleBillingSummary: BillingSummary = {
  ...
  checkout_options: [
    { kind: 'creator_monthly', label: 'Essential', credits: 4000, price_usd: 12, plan: 'creator' },
    { kind: 'pro_monthly', label: 'Premium', credits: 12000, price_usd: 24, plan: 'pro' },
  ],
  recent_activity: [],
}
