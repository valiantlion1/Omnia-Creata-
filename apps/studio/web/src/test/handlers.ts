...
export const samplePublicPlans: PublicPlansPayload = {
  ...
  subscriptions: [
    {
      ...
      feature_summary: ['400 monthly credits', 'Newer image models'],
      price_usd: 12,
    ...
    },
    {
      ...
      feature_summary: ['1200 monthly credits', 'Advanced and newest image models'],
      price_usd: 29,
      billing_period: 'month',
  ...
  credit_packs: [
    { kind: 'credit_pack_small', label: 'Credit pack 200', credits: 200, price_usd: 10, plan: null },
    { kind: 'credit_pack_large', label: 'Credit pack 800', credits: 800, price_usd: 29, plan: null },
  ],
  wallet: {
...
export const sampleBillingSummary: BillingSummary = {
  ...
  wallet: {
    balance: 40,
    wallet_balance: 40,
    included_monthly_allowance: 400,
  ...
  checkout_options: [
    { kind: 'creator_monthly', label: 'Creator', credits: 400, price_usd: 12, plan: 'creator' },
    { kind: 'pro_monthly', label: 'Pro', credits: 1200, price_usd: 29, plan: 'pro' },
  ],
  recent_activity: [],
}
