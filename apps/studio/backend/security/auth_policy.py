...
ROUTE_POLICY: dict[RoutePolicyKey, Policy] = {
    ...
    ("GET", "/v1/profiles/me/deletion"): "authenticated",
    ("DELETE", "/v1/profiles/me"): "authenticated",
    ("POST", "/v1/profiles/me/deletion/cancel"): "authenticated",
    ...
    ("GET", "/v1/admin/access-requests"): "admin",
    ("PATCH", "/v1/admin/access-requests/{request_id}"): "admin",
    ("POST", "/v1/admin/identity-deletions/process-due"): "admin",
