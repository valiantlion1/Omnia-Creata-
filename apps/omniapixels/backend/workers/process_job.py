...
Handles image processing tasks using AI Orchestrator
"""
...
def process_job(job_id: int):
    """Main job processing function - delegates to AI Orchestrator"""
    logging.info(f"Worker processing job {job_id}")
    return process_job_task(job_id)
